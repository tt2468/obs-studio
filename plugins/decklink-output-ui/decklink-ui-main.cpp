...
void onPreviewSceneChanged(enum obs_frontend_event event, void *)
{
...
void preview_output_stop()
{
	...
	obs_frontend_remove_event_callback(onPreviewSceneChanged, &context_preview);
...
void preview_output_start()
{
	...
	if (settings != nullptr) {
		...
		obs_frontend_add_event_callback(onPreviewSceneChanged, &context_preview);
